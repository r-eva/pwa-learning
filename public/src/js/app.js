  ...
  navigator.serviceWorker.ready
    ...
    .then(sub => {
      ...
      // create new subscribtion
        var vapidPublicKey = "BFfrnC5EioDWAbuWbxkr0zUfQ46saAo9Cuzayqq7nqgGuOx88d4WweiijCtGrCQuE31u4v9gf0SEAFu5nfGOyW4"
    ...
    .then(newSub => {
      fetch("https://pwagram-920d5-default-rtdb.firebaseio.com/subscriptios.json", {
        method: "POST",
        headers: {
